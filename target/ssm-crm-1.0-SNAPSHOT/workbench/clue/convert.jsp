...
<script type="text/javascript">
	$(function(){
		...
		$("#convertBtn").click(function () {
			if($("#isCreateTransaction").prop("checked")){
				...
				// alert("不需要交易")
				// 走传统请求，转换后跳转到新页面
				window.location.href = "workbench/clue/user/convert.do?clueId=${param.id}&flag=a"
			}
		})
	...
	// 查询所有市场活动源并选择
	function getActivityShow(){
		$.ajax({
			url :"workbench/clue/user/getActivityByName.do",
			data : {
...
<%--							</tr>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="convertForm" action="workbench/clue/user/convert.do">

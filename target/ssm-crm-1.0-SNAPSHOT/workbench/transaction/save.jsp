...
<script type="text/javascript">
	...
	$(function () {
        ...
        $("#create-customerName").typeahead({
            source: function (query, process) {
                $.get(
                    "workbench/transaction/user/getCustomerName.do",
                    { "name" : query },
                    function (data) {
                        //alert(data);
                        process(data);
		...
		$("#create-stage").change(function () {
			...
			// 可变变量不能以传统的json.key来取值 使用json[key],使用json[key]
	...
	function findActivity() {
		$.ajax({
			url :"workbench/transaction/user/getActivityListByName.do",
			data : {
	...
	function findContact() {
		$.ajax({
			url :"workbench/transaction/user/getContactListByName.do",
			data : {
				"name" : $.trim($("#searchActivity").val())
			},
			type :"get",
			...
			success : function(data){
				...
				$("#contactShowBody").html(html)
				$("input[name=cxz]").click(function () {
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" placeholder="请输入联系人名称，支持模糊查询" id="searchContact">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
...
<%--							</tr>--%>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="saveForm" action="workbench/transaction/user/save.do" method="post">
...
<%--				  <option>wangwu</option>--%>
		...
		<div class="form-group">
			<label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" id="findContact"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName">
				<input type="hidden" id="hidden-contactId" name="contactsId">
			</div>
		</div>
